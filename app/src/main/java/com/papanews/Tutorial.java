...
public class Tutorial extends AppCompatActivity {
    ...
    TextView tutorialDesc;
    ImageView tutoMimage, arrow, play_tutorial;
    TextView titleTuto, subTuto, ttaudio;
    private MediaPlayer mMediaPlayer;
    RelativeLayout relativre_touch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next = findViewById(R.id.nextTutorial);
