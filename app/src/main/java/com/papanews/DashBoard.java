...
//        itemsreco.add(new ItemModel("title",link,"PapaNews","",link,
//                "times","20","PapaNews","0","0",
//                "0","29/2/2021","recomended"
//        ));



        //declaration of layouts{start}
        viewPager = findViewById(R.id.viewPager);
        relativeLayout = findViewById(R.id.relative);
        introslapsh = findViewById(R.id.introsplash);
//        scrollView = (HorizontalScrollView) findViewById(R.id.scroll_view);
        shrtDesc = findViewById(R.id.discription);
...
//              scrollView.setVisibility(View.VISIBLE);
        ...
        //calling diffrent layout xmls{start}
        LayoutInflater inflater = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //{end}

        //setting text size of view pager according to diffrent screen sizes{screen text size start}
...
//                }
        ...
        refresh_but = findViewById(R.id.ref);
...
//                    @Override
//                    public void run() {
//                        ActionPlaying actionPlaying = new NewsFragment();
//                        actionPlaying.card_next();
//                        Log.e("nexting","in main ");
//
//                    }
//                }, 0, 2000);
...
//                NewsFragment fragment = (NewsFragment) getSupportFragmentManager().findFragmentByTag("Politics");
//                fragment.card_next();
            }
        });
//        new Handler().postDelayed(new Runnable() {
...
//    };
    ...
    public void updateTimeOnEachSecond() {
        ...
        pp = (ImageView) vi_audio.findViewById(R.id.play);
