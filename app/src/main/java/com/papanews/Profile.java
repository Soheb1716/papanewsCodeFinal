...
//                Toast.makeText(getActivity(), "Ctegory Activity", Toast.LENGTH_SHORT).show();
        ...
        String fb_email = sharedPreferences.getString("facebook_email", "");
        String google_em = sharedPreferences.getString("emailgoogle", "");
        if (!google_em.equals("")) {
            email = google_em;
        } else if (!fb_email.equals("")) {
            email = fb_email;
        }
